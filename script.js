...
function createParticle() {
    ...
    function attemptCreateParticle() {
        ...
        // Randomize size
        const baseSize = Math.random() * 20 + 9; // Random size between 10 and 30 pixels
        const shouldEnlarge = Math.random() < 0.4; // 40% chance to enlarge one particle
        const size = shouldEnlarge ? baseSize + 10: baseSize; // Increase size by 10 pixels if selected for enlargement
